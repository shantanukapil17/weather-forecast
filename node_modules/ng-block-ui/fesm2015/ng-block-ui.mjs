...
class BlockUIContentComponent {
    ...
    onStart({ name, message }) {
        var _a, _b;
        if (name === this.name) {
            const delay = (_b = (_a = this.delayStart) !== null && _a !== void 0 ? _a : this.settings.delayStart) !== null && _b !== void 0 ? _b : 0;
    ...
    onStop({ name }) {
        ...
        if (name === this.name) {
            ...
            if (this.state.startCallCount - stopCount >= 0) {
                const delay = (_b = (_a = this.delayStop) !== null && _a !== void 0 ? _a : this.settings.delayStop) !== null && _b !== void 0 ? _b : 0;
